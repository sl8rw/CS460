...
********************************************************************/
//this has been modified by SHW to include additional functions
#define DR   0x00
#define FR   0x18
...
int strcmp(const char *s1, const char *s2)
{
  ...
  //can return ascii value after comparison
...
int fuprintf(UART *up,char *fmt, ...) //page 42 Embedded Real Time
{
  char *cp=fmt;
  int *ip=(int *)&fmt+1;
  while(*cp){
